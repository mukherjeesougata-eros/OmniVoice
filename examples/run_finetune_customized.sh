...
TRAIN_JSONL="data/finetune/Rasa_emotions/rasa_emotions_train.jsonl"

# Path to your dev JSONL file. Set to empty string to skip dev set.
DEV_JSONL="data/finetune/Rasa_emotions/rasa_emotions_test.jsonl"

# Directory to write tokenized WebDataset shards
TOKEN_DIR="data/finetune/tokens/Rasa_emotions"

# Audio tokenizer model (HuggingFace repo or local path)
TOKENIZER_PATH="eustlb/higgs-audio-v2-tokenizer"

# Training config file
TRAIN_CONFIG="config/train_config_finetune_4_instruct.json"

# Data config file
data_config="config/data_config_finetune_extra_voice_design_features.json"

# Output directory for fine-tuned checkpoints
OUTPUT_DIR="exp/omnivoice_finetune/Rasa_emotions"
# =================================
