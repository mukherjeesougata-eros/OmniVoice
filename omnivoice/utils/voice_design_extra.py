...
_INSTRUCT_CATEGORIES = [
    ...
    # Emotion (English-only, no Chinese counterpart)
...
_INSTRUCT_ALL_VALID = (
    ...
    | _INSTRUCT_MUTUALLY_EXCLUSIVE[-3]  # accents
    | _INSTRUCT_MUTUALLY_EXCLUSIVE[-2]  # dialects
    | _INSTRUCT_MUTUALLY_EXCLUSIVE[-1]  # emotions
)
